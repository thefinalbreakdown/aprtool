...
st.markdown("""
Upload a single funding file (Bybit, WOOX, or Hyperliquid-compatible).

- Manually select timestamp and funding rate columns
- Set funding interval (e.g., 4 hours or 1 hour)
- Choose timeframe (30, 14, 7, 3, or 1 day)
- View multiple APR interpretations and charts
- Export enriched CSV
""")
